...
public sealed interface MultipleWeight extends TwoArgumentWeightFunction {
    MapCodec<WeightFunction> CODEC =
        Apply2.CODEC.flatXmap(MultipleWeight::optimize, MultipleWeight::normalize);
    ...
    record Apply2(WeightFunction argument1, WeightFunction argument2) implements MultipleWeight {
    ...
    record ApplyConstant(WeightFunction argument, double constant) implements MultipleWeight {
